        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            <div class="page-heading">
                ...
                <div class="heading-actions">
                    <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.tables') }}"><i
                            class="bi bi-download" aria-hidden="true"></i>
                        Export</a><a class="btn btn-primary btn-sm" href="{{ route('admin.adduser') }}"><i
            ...
            <section class="panel mt-3">
                <div class="panel-header">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('admin.adduser') }}"><i
                                class="bi bi-person-plus" aria-hidden="true"></i>
                            Add User</a>
                    </div>
                </div>
                    ...
                    <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Jan 12, 2026</td>
                                <td class="text-end">
                                    <a class="btn btn-light btn-sm" href="{{ route('admin.user-details') }}">View</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
