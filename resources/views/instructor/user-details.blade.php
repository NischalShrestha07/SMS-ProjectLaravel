            ...
            <div class="container-fluid px-3 px-lg-4 py-4">
                <div class="page-heading">
                    ...
                    <div class="heading-actions">
                        <a class="btn btn-outline-secondary btn-sm" href="{{ route('instructor.home') }}"><i class="bi bi-arrow-left"
                                aria-hidden="true"></i>
                            Back to Users</a><a class="btn btn-primary btn-sm" href="{{ route('instructor.create') }}"><i
                        ...
                        <div class="panel mb-3">
                            <div class="panel-header">
                                ...
                                <button class="btn btn-primary btn-sm"  type="button">
                                    <a class="text-white" href="{{route('instructor.user-details.edit',$user->id)}}">Edit User</a>
                                </button>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-4">
