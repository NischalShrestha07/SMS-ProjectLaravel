            ...
            <div class="container-fluid px-3 px-lg-4 py-4">
                <div class="page-heading">
                    ...
                    <div class="heading-actions">
                        <a class="btn btn-outline-secondary btn-sm" href="{{ route('instructor.tables') }}"><i
                                class="bi bi-download" aria-hidden="true"></i>
                            Export</a><a class="btn btn-primary btn-sm" href="{{ route('instructor.add-user') }}"><i
                ...
                <section class="panel mt-3">
                    <div class="panel-header">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-primary btn-sm" href="{{ route('instructor.add-user') }}"><i
                                    class="bi bi-person-plus" aria-hidden="true"></i>
                                Add User</a>
                        </div>
                    </div>
                                ...
                                @foreach ($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            src="{{ asset('instructor_assets/images/avatar/avatar-1.jpg') }}"
                                            alt="Sarah Ahmed" /> --}}
                                                <div>
                                        ...
                                        <td class="text-end">
                                            <a class="btn btn-light btn-sm"
                                                href="{{ route('instructor.user-details.show',$item->id) }}">View</a>
                                        </td>
                                    </tr>
                                @endforeach
