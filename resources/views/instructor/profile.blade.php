                    ...
                    <div class="col-12 col-xl-4">
                        <div class="panel h-100 text-center profile-card">
                            ...
                            <div class="info-list mt-4 text-start">
                                ...
                                <div><span>Department</span><strong>---</strong></div>
                        ...
                        <form action="{{route('instructor.profile.update')}}" method="POST" class="panel needs-validation" novalidate>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6"><label class="form-label" for="profileName">Name</label><input
                                        class="form-control" id="profileName" name="name" type="text" value="{{ Auth::user()->name }}" required>
@error('name')
    <span class="text-danger">{{$message}}</span>
@enderror                                </div>
                                <div class="col-md-6"><label class="form-label" for="profileEmail">Email</label><input
                                        class="form-control" id="profileEmail" name="email" type="email" value="{{ Auth::user()->email }}"
                                        required>
@error('email')
    <span class="text-danger">{{$message}}</span>
@enderror                                                            </div>
                                ...
                                <div class="col-md-6"><label class="form-label" for="profileEmail">Phone</label><input
                                        class="form-control" id="profileEmail" name="phone" type="text" value="{{ Auth::user()->phone }}"
                                        >
@error('phone')
    <span class="text-danger">{{$message}}</span>
@enderror                                                            </div>

 <div class="col-md-6"><label class="form-label" for="profileEmail">Password</label><input name="password"
                                        class="form-control" id="profileEmail" type="text" value=""
                                        >
@error('password')
    <span class="text-danger">{{$message}}</span>
@enderror                                                            </div>
