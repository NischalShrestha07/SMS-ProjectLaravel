            ...
            <div class="container-fluid px-3 px-lg-4 py-4">
                <div class="page-heading">
                    ...
                    <div class="heading-actions">
                        <a class="btn btn-outline-secondary btn-sm" href="{{ route('student.home') }}"><i class="bi bi-arrow-left"
                                aria-hidden="true"></i>
                            Back to Users</a><a class="btn btn-primary btn-sm" href="{{ route('student.create') }}"><i
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="panel h-100 text-center profile-card">
                            <div class="profile-cover">
                                <img src="{{ asset('student_assets/images/png/dasher-ui-bootstrap-5.jpg') }}"
                                    alt="User workspace preview" />
                            </div>
                            <div class="profile-hero">
                                <img class="avatar-img avatar-xl profile-photo"
                                    src="{{ asset('student_assets/images/avatar/avatar-1.jpg') }}" alt="Sarah Ahmed" />
                        ...
                        <div class="panel mb-3">
                            <div class="panel-header">
                                ...
                                <button class="btn btn-primary btn-sm"  type="button">
                                    <a class="text-white" href="{{route('student.user-details.edit',$user->id)}}">Edit User</a>
                                </button>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-4">
