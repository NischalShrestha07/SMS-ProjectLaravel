            ...
            <div class="container-fluid px-3 px-lg-4 py-4">
                <div class="page-heading">
                    ...
                    <div class="heading-actions">
                        <a class="btn btn-outline-secondary btn-sm" href="{{ route('student.tables') }}"><i
                                class="bi bi-download" aria-hidden="true"></i>
                            Export</a><a class="btn btn-primary btn-sm" href="{{ route('student.adduser') }}"><i
                ...
                <section class="panel mt-3">
                    <div class="panel-header">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-primary btn-sm" href="{{ route('student.adduser') }}"><i
                                    class="bi bi-person-plus" aria-hidden="true"></i>
                                Add User</a>
                        </div>
                    </div>
                                ...
                                @foreach ($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            src="{{ asset('student_assets/images/avatar/avatar-1.jpg') }}"
                                            alt="Sarah Ahmed" /> --}}
                                                <div>
                                        ...
                                        <td class="text-end">
                                            <a class="btn btn-light btn-sm"
                                                href="{{ route('student.user-details.show',$item->id) }}">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    <div>
